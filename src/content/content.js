...
// imports of all The images 

import uiux from "../public/uiux8.avif";

import uiux2 from "../public/uiux2.avif";

import uiux3 from "../public/uiux3.avif";

import uiux4 from "../public/uiux4.avif";

import uiux5 from "../public/uiux.png";

import uiux6 from "../public/uiux6.avif";

import uiux7 from "../public/uiux7.avif";

import uiux8 from "../public/uiux8.avif";
...
export const importantToKnow = [
  ...
  "You will have 30 seconds for each question. If you fail to complete a question in given time, your answer will be considered incorrect.",
];
 ...
 export const quizQuestions = [
  ...
  {
    imageUrl:uiux3,
    question: "What is the main purpose of creating user personas?",
    options: [
      "A. Showcasing design concepts to stakeholders",
      "B. Representing fictional users for marketing purposes",
      "C. Understanding and empathizing with target users",
...

  {
    ...
    options: [
      "A. Comparing two different design concepts visually",
      "B. Identifying bugs and errors in the user interface",
  ...
  },
  {
    ...
    options: [
      ...
      "C. Gaining inspiration for unique design solutions",
  ...
  },
  {
    ...
    options: [
      "A. Providing a step-by-step guide for developers to implement the design",
      "B. Showcasing the visual elements of a design concept",
      "C. Ensuring consistency and maintaining a unified design language",
  ...
  },
  {
    ...
    options: [
      ...
      "C. Evaluating the usability of a product based on a set of usability principles",
  ...
  },
  {
    ...
    options: [
      ...
      "C. Determining the color scheme for the design",
