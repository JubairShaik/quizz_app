...
const Intro = ({ onGetStartedClick }) => {
  return (
    <div className="px-5 py-8 md:py-14 flex-1 w-full   lg:gap-[2rem]  gap-[3rem] lg:max-w-4xl mx-auto flex flex-col overflow-hidden">
      ...
      <div className="w-full flex flex-col flex-1 items-center z-10">
        ...
        <img
        src={computer}
        className=" h-[18rem] mt-5 object-cover pointer-events-none "
        alt="Illustration"
      />
      </div>
